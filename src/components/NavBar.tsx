      ...
      <div className="container mx-auto flex items-center justify-between whitespace-nowrap px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="md:flex items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            {/* <button className="flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-sm font-bold text-white transition-colors hover:bg-primary/90">Get Started</button> */}
            <button
